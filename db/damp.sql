...
(1,	1,	'ЛУКОЙЛ-Пермнефтеоргсинтез',	NULL,	56.1346460146535,	57.92231916465072,	2000);
...
CREATE TABLE "public"."gas_analyzer" (
    ...
    "longitude" real NOT NULL,
    "latitude" real NOT NULL,
    CONSTRAINT "gas_analyzer_measurement_city_id" PRIMARY KEY ("measurement", "city_id")
) WITH (oids = false);

INSERT INTO "gas_analyzer" ("measurement", "city_id", "longitude", "latitude") VALUES
...
ALTER TABLE ONLY "public"."gas_analyzer" ADD CONSTRAINT "gas_analyzer_company_id_fkey" FOREIGN KEY (city_id) REFERENCES city(id) ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;
